...
while True:
	...
	for item in rankings:
		...
		(round(stats.percentileofscore(auto, item[4])*100)/100), ", ".join(abilities[str(item[1])]["Auto Abilities"]), 
		(round(stats.percentileofscore(climb, item[6])*100)/100), 
		(round(stats.percentileofscore(gear, item[5])*100)/100), ", ".join(abilities[str(item[1])]["Gear Pickup"]), abilities[str(item[1])]["Gear Placement"], 
		(round(stats.percentileofscore(balls, item[7])*100)/100), ", ".join(abilities[str(item[1])]["Ball Pickup"]),
